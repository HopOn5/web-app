...
const AppRouter = () => {
  return (
    <Routes>
      ...
      <Route path={URLData.resetpassword.url} element={<ResetPassword />} />
      ...
      <Route path={URLData.routeRequest.url} element={<RouteRequests />} />
      <Route path={URLData.routeRequestList.url} element={<RequestList />} />
