...
import { getLabel } from "../onBoarding/utils";
    ...
    <div className="basic-details__card">
      ...
      <div className="basic-details">
        <div className="basic-details__items">
          ...
          <div className="basic-details__items_child">DATE OF BIRTH:</div>
        </div>
        <div className="basic-details__items">
          <div className="basic-details__items_child_ans">
            {data?.phoneNumber}
          </div>
          <div className="basic-details__items_child_ans">{data?.email}</div>
          <div className="basic-details__items_child_ans">
            {getLabel(data?.gender)}
          </div>
          <div className="basic-details__items_child_ans">{data?.dob}</div>
        </div>
      </div>
    </div>
  );
